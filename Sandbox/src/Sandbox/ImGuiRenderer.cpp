    ...
    if (open)
    {
        ...
        for (auto& prop : ptr->GetComponentProperties().GetProperties())
        {
            ...
            case Lamp::PropertyType::Int:
                propertyChanged = UI::Property(prop.name, *static_cast<int*>(prop.value));
                break;
            case Lamp::PropertyType::Bool:
                propertyChanged = UI::Property(prop.name, *static_cast<bool*>(prop.value));
                break;
            case Lamp::PropertyType::Float:
                propertyChanged = UI::Property(prop.name, *static_cast<float*>(prop.value));
                break;
            case Lamp::PropertyType::Float2:
                propertyChanged = UI::Property(prop.name, *static_cast<glm::vec2*>(prop.value));
                break;
            case Lamp::PropertyType::Float3:
                propertyChanged = UI::Property(prop.name, *static_cast<glm::vec3*>(prop.value));
                break;
            case Lamp::PropertyType::Float4:
                propertyChanged = UI::Property(prop.name, *static_cast<glm::vec4*>(prop.value));
                break;
            case Lamp::PropertyType::String:
                propertyChanged = UI::Property(prop.name, *static_cast<std::string*>(prop.value));
                break;
            case Lamp::PropertyType::Path:
                propertyChanged = UI::Property(prop.name, std::filesystem::path(*static_cast<std::string*>(prop.value)));
                break;
            case Lamp::PropertyType::Color3:
                propertyChanged = UI::Property(prop.name, *static_cast<glm::vec3*>(prop.value), false);
                break;
            case Lamp::PropertyType::Color4:
                propertyChanged = UI::Property(prop.name, *static_cast<glm::vec4*>(prop.value), true);
                break;
            }
