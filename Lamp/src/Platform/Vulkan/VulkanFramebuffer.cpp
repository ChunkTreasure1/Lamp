	...
	namespace Utils
	{
		static VkFormat LampFormatToVulkanFormat(ImageFormat format)
		{
			switch (format)
			{
				...
				case ImageFormat::R32I: return VK_FORMAT_R8_SINT;
				case ImageFormat::R32F: return VK_FORMAT_R16_SFLOAT;
	...
	void VulkanFramebuffer::Invalidate()
	{
		...
		for (auto attachmentSpec : m_specification.attachments.Attachments)
		{
			if (Utils::IsDepthFormat(attachmentSpec.textureFormat))
			{
				...
				attachmentDesc.loadOp = VK_ATTACHMENT_LOAD_OP_CLEAR; // add more OPs
