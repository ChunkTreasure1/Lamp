...
PointShadowBuffer::PointShadowBuffer(const FramebufferSpecification &spec)
  ...
  m_Projection = glm::perspective(
      glm::radians(90.f), (float)spec.Width / (float)spec.Height, 1.f, 100.f);

  m_Transforms.push_back(m_Projection *
                         glm::lookAt(m_Position,
                                     m_Position + glm::vec3(1.f, 0.f, 0.f),
...
void PointShadowBuffer::Unbind() { glBindFramebuffer(GL_FRAMEBUFFER, 0); }
