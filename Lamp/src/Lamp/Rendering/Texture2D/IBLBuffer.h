...
public:
    ...
    void Bind();
    inline const uint32_t GetTextureID() {
        return m_CubeMapId;
    }
    inline const uint32_t GetPrefilterID() {
        return m_PrefilterMap;
    }
    inline const uint32_t GetBRDFLUTID() {
        return m_TestTexture->GetID();
    }
    inline const uint32_t GetIrradianceID() {
        return m_IrradianceId;
    }
