...
namespace Lamp
{
	...
	void ShaderLibrary::LoadShaders()
	{
		...
		AddShader("engine/shaders/3d/ssaoDepth_vs.glsl", "engine/shaders/3d/ssaoDepth_fs.glsl");
		AddShader("engine/shaders/3d/ssaoDepth_vs.glsl", "engine/shaders/3d/ssaoMain_fs.glsl");
	}
