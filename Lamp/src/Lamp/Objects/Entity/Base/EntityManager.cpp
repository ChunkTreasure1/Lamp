...
EntityManager::EntityManager() { s_CurrentManager = this; }

EntityManager::~EntityManager() { m_pEntites.clear(); }
...
Entity *EntityManager::GetEntityFromPoint(const glm::vec3 &pos,
                                          const glm::vec3 &origin) {
  Entity *entity = dynamic_cast<Entity *>(
