...
namespace Lamp
{
	...
	public:
		...
		static physx::PxBroadPhaseType::Enum LampToPhysXBroadphaseType(BroadphaseType type);
		static physx::PxFrictionType::Enum LampToPhysXFrictionType(FrictionType type);
	};
}